...
$branchs = mysqli_query($dbconn,"SELECT * FROM `branches` where deleted_at is null and branch_id in (16,15,2,4,7,17,19,20,21)");
...
// $response = sendWhatsAppAuthkey("7046673769", "35671", $bodyValues);
// echo "<pre/>";
// print_r($bodyValues);exit;

$response = sendWhatsAppAuthkey("8401442448", "35671", $bodyValues);
$response = sendWhatsAppAuthkey("9724630450", "35671", $bodyValues);
