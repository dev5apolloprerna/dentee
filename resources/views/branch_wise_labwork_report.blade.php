...
<table style="width: 100%;background-image: url(https://vgdcapp.vrajdentalclinic.com/assets/images/background.png);!important;padding: 60px;">
    ...
    <tbody>
        <tr>
			<td colspan="4" style="text-align: left;border: none;"><b>Lab Name :{{ $LabworkData->lab_name }}</b></td>
		...
		<tr>
            <td colspan="9" style="text-align: center;border: none;"><b>Branch:{{ $LabWork['branchName'] }} </b></td>
		</tr>
		<tr>
			<tdcolspan="9" style="border: none;">&nbsp;</td>
		</tr>
