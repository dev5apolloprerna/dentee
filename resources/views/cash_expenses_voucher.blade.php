...
<body>
    <div class="voucher">
        ...
        <div class="detail-row">
            ...
            <span class="value">{{ number_format($Collection['cash_amount'], 2) }}</span>
        </div>
        
        <div class="detail-row">
            <span class="label">Paid To:</span>
            <span class="value">{{ $Collection['paid_to'] }}</span>
        </div>
        
        <div class="detail-row">
            <span class="label">Date:</span>
            <span class="value">{{ $Collection['date'] }}</span>
        </div>
        
        <div class="detail-row">
            <span class="label">Branch Name:</span>
            <span class="value">{{ $Collection['branch_name'] }}</span>
        </div>
