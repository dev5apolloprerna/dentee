...
<table style="width: 100%;background-image: url(https://vgdcapp.vrajdentalclinic.com/assets/images/background.png);!important; padding: 60px;">
    ...
    <tbody>
        <tr>
            ...
            <td colspan="4" style="text-align: right; border: none;"><b>Duration:{{ trim($Duration) }}</b></td>
    	</tr>
    	<tr>
        	<td colspan="7">&nbsp;</td>
    	</tr>
    	...
    	<tr>
        	<td colspan="7" style="text-align: center; border: none;"><b>Branch:{{ $branchName }}</b></td>
    	</tr>
    	<tr>
        	<td colspan="7">&nbsp;</td>
    	</tr>
