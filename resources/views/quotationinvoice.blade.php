...
<table style="width: 100%;background-image: url(https://vgdcapp.vrajdentalclinic.com/assets/images/background.png);!important;padding: 60px;">
    ...
    <tbody style="width: 100%;">
        <tr>
            <td colspan="4" style="width: 80%;padding: 5px;">Patient Name:- {{ $Treatments[0]['name_prefix']}} {{$Treatments[0]['patient_name'] }}({{$Treatments[0]['case_no']}})</td>
            <td colspan="2" style="width: 20%;padding: 5px;">Date:-{{ $Treatments[0]['treatment_date']}}</td>
        </tr>
        <tr>
    		 <?php 
    		if(!empty($Treatments[0]['patient_address'])){
    			?>
    				...
    				<td colspan="6" style="width: 80%;padding: 5px;">Address:- {{$Treatments[0]['patient_address']}}</td>
    	
    			<?php
    		}else{
    		?>
    				<td colspan="6" style="width: 80%;padding: 5px;">Address : - </td>
...
<!--<tbody style="width: 100%;padding-bottom: 0px;">
    <tr>
        <td rowspan="4" style="width:50%;border:none;border-top:1px solid black;border-left:1px solid black;">
		<img src="https://vgdcapp.vrajdentalclinic.com/assets/images/logo_n.png" alt=""></td>
...
<!--<tbody style="width: 100%;">
   ...
   <?php 
    ...
    <tbody>
        <tr>
            <td style="border: none;"><img style="text-align:center;width: 100%;position: absolute;bottom:0px;left:0px;" src="https://vgdcapp.vrajdentalclinic.com/assets/images/new-footer.png" alt=""></td>
        </tr>
    </tbody>
</table>
