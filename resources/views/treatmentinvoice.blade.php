...
<table style="width: 100%;background-image: url(https://vgdcapp.vrajdentalclinic.com/assets/images/background.png);!important;padding: 60px;">
    ...
    <tbody style="width: 100%;">
        <tr>
            <td colspan="4" style="width: 40%;padding: 5px;">Patient Name:- {{ $Treatments[0]['name_prefix']}} {{$Treatments[0]['patient_name'] }}({{$Treatments[0]['case_no']}})</td>
            <td colspan="2" style="width: 60%;padding: 5px;">Date:-{{ $Treatments[0]['treatment_date']}}</td>
        </tr>
        <tr>
